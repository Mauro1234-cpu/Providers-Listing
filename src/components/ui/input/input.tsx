...
const inputVariants = tv({
  slots: {
    ...
    input:
      "flex w-full rounded-md border border-border-default-default bg-background-base-default px-3 py-1 text-base text-text-default-default transition-colors placeholder:text-text-disabled-default focus:border-border-brand-default focus:outline-none focus-visible:outline-border-brand-default disabled:cursor-not-allowed disabled:bg-background-disabled-default disabled:text-text-disabled-on-disabled md:text-sm",
